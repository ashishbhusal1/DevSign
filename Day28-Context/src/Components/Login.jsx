  ...
  return (
    ...
    <div className="container">
      <div className="content">
        <h1>Zoho.</h1>
        <p>
          A central hub where teams can work, plan, <br /> and achieve amazing things
          together.
        </p>
        <img src={HeroImg} alt="" />
      </div>
      <div className="login">
        ...
        <div className="start">
          ...
          <div className="input">
            ...
            <span>Password</span>
            <input type="email" placeholder="6+ Characters, 1 Capital letter" />
          </div>
        ...
        <p className="text">
          <span> This site is protected by reCAPTCHA and the Google</span> <span className="blue"> Privacy Policy </span>and
